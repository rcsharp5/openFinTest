...
/***/ function(module, exports, __webpack_require__) {
	...
	function log(text) {
	    request.post('/savelog').send(UUID + "::" + text).end(function (err, res) {});
	...
	function runOpenFinTest(loopNumber, params, callback) {
	    ...
	    function windowComplete(err, newWin) {
	        ...
	        if (spawnedCount === spawnCount) {
	            ...
	            log("Final Time for " + spawnCount + " windows:" + finalTime + " for an average of " + Math.round(finalTime / spawnCount * 100) / 100 + " seconds per window");
